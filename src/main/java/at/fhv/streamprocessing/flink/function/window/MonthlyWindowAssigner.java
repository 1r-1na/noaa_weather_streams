...
public class MonthlyWindowAssigner extends WindowAssigner<Object, TimeWindow> {
    ...
    public Collection<TimeWindow> assignWindows(Object element, long timestamp, WindowAssignerContext context) {
        ...
        ZonedDateTime startOfMonth = zonedDateTime.withDayOfMonth(1).toLocalDate().atStartOfDay(systemDefault());
        long start = startOfMonth.toInstant().toEpochMilli();
        long end = startOfMonth.plusMonths(1).toInstant().toEpochMilli();
